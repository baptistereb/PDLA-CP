...
public class FeedVolunteer {
    ...
    public void createPage() {
        ...
        for (List<String> post : posts) {
            ...
            JLabel userLabel1 = new JLabel("Beneficiary having joined : "+String.join(", ", FeedVolunteerController.userJoined(Integer.parseInt(post.get(0)), "need_help")));
            JLabel userLabel2 = new JLabel("Volunteer having joined : "+String.join(", ", FeedVolunteerController.userJoined(Integer.parseInt(post.get(0)), "help")));
            ...
            if(FeedVolunteerController.isItYourMission(Integer.parseInt(post.get(2)))) {
                JButton terminateButton = new JButton("Terminate the mission");
                terminateButton.addActionListener(e -> {
                    // keskispass quand on clique sur accepter
                    FeedVolunteerController.terminateMission(Integer.parseInt(post.get(0)));
                    masterView.loadWindow("feed_volunteer");
                });
